...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-dbcd2b91><h1 class="title" data-v-dbcd2b91>${ssrInterpolate(_ctx.$t("projects"))}</h1><div class="filter" style="${ssrRenderStyle({ direction: `${_ctx.changeDirection($options.activeLang)}` })}" data-v-dbcd2b91><p data-v-dbcd2b91>${ssrInterpolate(_ctx.$t("show"))}:</p><ul data-v-dbcd2b91><!--[-->`);
  ssrRenderList($options.tags, (tag, index) => {
    ...
    })}" data-v-dbcd2b91>${ssrInterpolate(tag.name)}</li>`);
  });
  _push(`<!--]--></ul></div><div class="projects-cards" data-v-dbcd2b91><!--[-->`);
...
const projects = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-dbcd2b91"]]);

export { projects as default };
//# sourceMappingURL=projects-D9ybjqCB.mjs.map
