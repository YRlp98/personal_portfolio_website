...
const SocialNetwork = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-ca3b640e"]]);
const _sfc_main = {
...
const TitleBackground = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-854c4125"]]);
const changeAlign = {
  methods: {
    changeAlign(language) {
      if (language === "fa") {
        return "right";
      } else {
        return "left";
...
export { SocialNetwork as S, TitleBackground as T, changeAlign as c };
//# sourceMappingURL=changeAlign-BBn-GU6S.mjs.map
