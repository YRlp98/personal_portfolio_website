...
function _sfc_ssrRender$e(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    ...
    id: "homeAboutMe"
  }, _attrs))} data-v-0641dcc9><h2 class="aboutMe-title" style="${ssrRenderStyle({ textAlign: `${_ctx.changeAlign($options.activeLang)}` })}" data-v-0641dcc9>${ssrInterpolate(_ctx.$t("homePageAboutMe"))}</h2><div class="aboutMe-avatar" data-v-0641dcc9><img src="https://lixbjgupmbwyplqhzkde.supabase.in/storage/v1/object/sign/yrlp-storage/Images/Yousef_Roshandel.webp?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJ5cmxwLXN0b3JhZ2UvSW1hZ2VzL1lvdXNlZl9Sb3NoYW5kZWwud2VicCIsImlhdCI6MTYzODE5OTg4NSwiZXhwIjoxOTUzNTU5ODg1fQ.VKVFopNxk-Ewlr32JwQdmybEs9oPvsxP5OXNZrxjBNs" alt="Yousef Roshandel" data-v-0641dcc9><div class="square" data-v-0641dcc9></div></div><p class="aboutMe-text" style="${ssrRenderStyle({ direction: `${_ctx.changeDirection($options.activeLang)}` })}" data-v-0641dcc9>${ssrInterpolate(_ctx.$t("homePageAboutMeText"))}</p>`);
...
const AboutMe = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$e], ["__scopeId", "data-v-0641dcc9"]]);
const _sfc_main$d = {
  name: "HomeTitle",
  props: {
    title: {
